...
class Time {
	...
	*/
	public static function nice($dateString = null, $format = 'j M Y, H:i') {
	...
	*/
	public static function niceShort($dateString = null) {
		...
		if (self::isToday($date)) {
			$ret = sprintf(trans('backend/common.today') . ', %s', date("H:i", $date));
		} elseif (self::wasYesterday($date)) {
			$ret = sprintf(trans('backend/common.yesterday') . ', %s', date("H:i", $date));
		} else {
