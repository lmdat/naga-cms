...
<section class="content">
    <div class="row">
        <div class="col-md-6 col-sm-6">
            {!! Form::open(['url' => Request::url() . $qs, 'name' => 'adminForm', 'id' => 'adminForm', 'role' => 'form']) !!}
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group @if($errors->has('first_name')) has-error @endif">
                            ...
                            {!! Form::text('first_name', '', ['id'=>'first_name', 'class' => 'form-control', 'required'=>true, 'placeholder' => 'Required']) !!}
                            @if ($errors->has('first_name'))<p><small class="text-red">{!!$errors->first('first_name')!!}</small></p> @endif
                        </div>

                        <div class="form-group  @if($errors->has('surname')) has-error @endif">
                            <label for="surname">Surname</label>
                            {!! Form::text('surname', '', ['id'=>'surname', 'class' => 'form-control', 'required'=>true, 'placeholder' => 'Required']) !!}
                             @if ($errors->has('surname'))<p><small class="text-red">{!!$errors->first('surname')!!}</small></p> @endif
                        </div>
                        
                        <div class="form-group  @if($errors->has('email')) has-error @endif">
                            <label for="email">Email</label>
                            {!! Form::email('email', '', ['class' => 'form-control', 'required'=>true, 'placeholder' => 'Required|Email|Unique']) !!}
                            @if ($errors->has('email'))<p><small class="text-red">{!!$errors->first('email')!!}</small></p> @endif
                        </div>
                        
                        <div class="form-group  @if($errors->has('password')) has-error @endif">
                            <label for="password">Password</label>
                            {!! Form::password('password', ['id'=>'password', 'class' => 'form-control', 'required'=>true, 'placeholder' => 'Required|Min:6']) !!}
                        ...
                        <div class="form-group @if($errors->has('roles')) has-error @endif">
                            <label for="roles[]">Role</label>
                                ...
                                <div class="checkbox">
                                    <label>
                                        {!! Form::checkbox('roles[]', $role->id, false, ['id' => 'role_' . $role->id]) !!} {{$role->role_name}}
                                    </label>
                                </div>
                                @endforeach
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <label class="radio-inline">
                                    {!! Form::radio('active', 1, true, ['id'=>'active1']) !!} Yes
                                </label>
                                <label class="radio-inline">
                                    {!! Form::radio('active', 0, false, ['id'=>'active0']) !!} No
                                </label>
                            </div>
                        </div>
