...
@section('content')
    <section class="content-header">
        <h1>
            ...
            <small>{{ trans($lang_mod . '.is_cat_highlight') }}</small>
        </h1>
        {{--<ol class="breadcrumb">--}}
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            @foreach($news_list as $item)
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a href="{{ url($prefix_url . '/cat-highlight/remove', [$item->id]) . $qs }}" class="btn btn-sm btn-danger btn-flat" data-toggle="tooltip" title="{{ trans($lang_common . '.btn_delete') }}"><i class="fa fa-remove"></i></a>
                                    </td>
                                </tr>
