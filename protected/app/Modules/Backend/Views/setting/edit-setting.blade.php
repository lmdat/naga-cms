...
@section('content')
    <section class="content-header">
        <h1>
            {{ trans($lang_mod . '.setting_edit_header') }}
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group @if($errors->has('site_name')) has-error @endif">
                            <label for="published">{{ trans($lang_mod . '.site_name') }}</label>
                            {!! Form::text('site_name', @$setting->site_name, ['id'=>'site_name', 'class' => 'form-control input-sm', 'placeholder' => 'Required']) !!}
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::textarea('website_default_description', @$setting->website_default_description, ['id'=>'website_default_description', 'class' => 'form-control input-sm', 'rows'=> 4, 'placeholder' => '']) !!}

                        </div>

                        <div class="form-group @if($errors->has('fb_id')) has-error @endif">
                            <label for="published">{{ trans($lang_mod . '.fb_id') }}</label>
                            {!! Form::text('fb_id', @$setting->fb_id, ['id'=>'fb_id', 'class' => 'form-control input-sm', 'placeholder' => '']) !!}
                        ...
                        <div class="form-group @if($errors->has('fb_page')) has-error @endif">
                            ...
                            {!! Form::text('fb_page', @$setting->fb_page, ['id'=>'fb_page', 'class' => 'form-control input-sm', 'placeholder' => '']) !!}
                        ...
                        <div class="form-group @if($errors->has('fb_page_id')) has-error @endif">
                            ...
                            {!! Form::text('fb_page_id', @$setting->fb_page_id, ['id'=>'fb_page_id', 'class' => 'form-control input-sm', 'placeholder' => '']) !!}
                            @if ($errors->has('fb_id'))<p><small class="text-red">{!!$errors->first('fb_id')!!}</small></p> @endif
                        </div>

                        <div class="form-group @if($errors->has('ga_id')) has-error @endif">
                            <label for="published">{{ trans($lang_mod . '.ga_id') }}</label>
                            {!! Form::text('ga_id', @$setting->ga_id, ['id'=>'ga_id', 'class' => 'form-control input-sm', 'placeholder' => '']) !!}
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::textarea('custom_analytics_script', @$setting->custom_analytics_script, ['id'=>'custom_analytics_script', 'class' => 'form-control input-sm', 'rows'=> 4, 'placeholder' => '']) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group input-group-sm">
                                {!! Form::text('default_seo_image', @$setting->default_seo_image, ['id'=>'default_seo_image', 'class' => 'form-control input-sm', 'placeholder' => '']) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <label class="radio-inline">
                                    {!! Form::radio('website_on_off', 1, $setting->website_on_off == 1, ['id'=>'website_on_off1']) !!} {{ trans($lang_common . '.radio_on') }}
                                </label>
                                <label class="radio-inline">
                                    {!! Form::radio('website_on_off', 0, $setting->website_on_off == 0, ['id'=>'website_on_off0']) !!} {{ trans($lang_common . '.radio_off') }}
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group @if($errors->has('website_off_message')) has-error @endif">
                            ...
                            {!! Form::textarea('website_off_message', $setting->website_off_message, ['id'=>'website_off_message', 'class' => 'form-control input-sm', 'rows'=> 4, 'placeholder' => 'Required']) !!}
                            @if ($errors->has('website_off_message'))<p><small class="text-red">{!!$errors->first('website_off_message')!!}</small></p> @endif
                        </div>
                    ...
                    <div class="box-footer">
                        <div class="text-right">
                            <button type="submit" class="btn bg-orange btn-sm btn-flat"><i class="fa fa-save"></i> {{ trans($lang_common . '.btn_update') }}</button>
