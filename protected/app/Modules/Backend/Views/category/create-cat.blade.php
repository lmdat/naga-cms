...
@section('content')
    <section class="content-header">
        <h1>
            {{ trans($lang_mod . '.category_create_header') }}
            <small></small>
        </h1>
        <!--ol class="breadcrumb">
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-7">
                {!! Form::open(['url' => Request::url() . $qs, 'name' => 'catForm', 'id' => 'catForm', 'role' => 'form']) !!}
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::select('parent_id', $tree_data, '', ['class' => 'form-control input-sm', 'id' => 'parent_id']) !!}
                        </div>

                        <div class="form-group @if($errors->has('cat_name')) has-error @endif">
                            <label for="province_name">{{ trans($lang_mod . '.cat_name') }}</label>
                            {!! Form::text('cat_name', '', ['id'=>'cat_name', 'class' => 'form-control input-sm', 'placeholder' => 'Required']) !!}
