...
@section('content')
    <section class="content-header">
        <h1>
            {{ trans($lang_mod . '.ads_edit_header') }}
            <small></small>
        </h1>
        <!--ol class="breadcrumb">
    ...
    <section class="content">
        <div class="row">
            {!! Form::open(['url' => Request::url() . $qs, 'method' => 'put', 'name' => 'adsForm', 'id' => 'adsForm', 'role' => 'form']) !!}
            <div class="col-md-8">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group @if($errors->has('pos_id')) has-error @endif">
                            ...
                            <select name="pos_id" id="pos_id" class="form-control input-sm">
                                ...
                                @foreach($positions as $item)
                                    ...
                                    @else
                                        <option value="{{$item->id}}" @if($item->status == 0) disabled="disabled" @endif @if($item->id == $ads->pos_id) selected @endif>{{ $item->pos_name }}</option>
                                    @endif
                        ...
                        <div class="form-group @if($errors->has('ads_title')) has-error @endif">
                            ...
                            {!! Form::text('ads_title', $ads->ads_title, ['id'=>'ads_title', 'class' => 'form-control input-sm', 'placeholder' => 'Required']) !!}
                        ...
                        <div class="form-group @if($errors->has('ads_content')) has-error @endif">
                            ...
                            {!! Form::textarea('ads_content', $ads->ads_content, ['id'=>'ads_content', 'class' => 'form-control input-sm', 'placeholder' => 'Required', 'rows' => 10]) !!}
            ...
            <div class="col-md-4">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">{{ trans($lang_mod . '.status') }}</h3>
                    </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <span id="status_content">
                                        ...
                                        @else
                                            {{ $ads->status == 1 ? trans($lang_common . '.radio_show') : trans($lang_common . '.radio_hide') }}
                                        @endif
                                    </span>
                                    @if($can_change_publish == false)
                            ...
                            <div id="status_form" class="row" style="display: none">
                                <div class="container-fluid">
                                    <div class="col-sm-7">
                                        {!! Form::checkbox('status', 1, $ads->status == 1, ['id' => 'status', 'class'=>'form-control input-switch', 'data-size' => 'small', 'data-on-text'=>trans($lang_common . '.radio_show'), 'data-off-text'=>trans($lang_common . '.radio_hide')]) !!}
                                    </div>
                                    <div class="col-md-5">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <span id="published_at_content">
                                        @if($errors->any())
                                            {{ old('published_at') != '' ? old('published_at') : trans($lang_mod . '.publish_now') }}
                                        @else
                                            {{ $ads->auto_publish != null ? \App\Libs\Utils\Vii::formatDateTime($ads->auto_publish->published_at, 'd/m/Y H:i') : \App\Libs\Utils\Vii::formatDateTime($ads->published_at, 'd/m/Y H:i') }}

                                        @endif
                                    </span>
                                    @if($can_change_publish == true)
                                ...
                                <div class="container-fluid">
                                    <div class="col-md-7">
                                        ...
                                        <div class="input-group">
                                            ...
                                            @if($ads->auto_publish == null)
                                            {!! Form::text('published_at', \App\Libs\Utils\Vii::formatDateTime($ads->published_at, 'd/m/Y H:i'), ['id'=>'published_at', 'class' => 'form-control input-sm', 'placeholder' => 'DD/MM/YYYY HH:mm']) !!}
                                            @else
                                            {!! Form::text('published_at', \App\Libs\Utils\Vii::formatDateTime($ads->auto_publish->published_at, 'd/m/Y H:i'), ['id'=>'published_at', 'class' => 'form-control input-sm', 'placeholder' => 'DD/MM/YYYY HH:mm']) !!}
                                            @endif
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <?php
                                        ...
                                        if($errors->any()){
                                            ...
                                            if($ads->start_time != '' && $ads->end_time){
                                                $start_time = \App\Libs\Utils\Vii::formatDateTime($ads->start_time, 'd/m/Y H:i');
                                                $end_time = \App\Libs\Utils\Vii::formatDateTime($ads->end_time, 'd/m/Y H:i');
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                {!! Form::text('display_time', $display_time, ['id'=>'display_time', 'class' => 'form-control input-sm', 'placeholder' => '']) !!}
                                            </div>
                                        </div>
                                    </div>
